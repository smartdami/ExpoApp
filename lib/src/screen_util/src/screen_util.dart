...
class ScreenUtil {
  static const Size defaultSize = Size(360, 700);
  ...
  double get scaleWidth =>
      ...
      scale; //(GlobalValues.languageKey ==  AppConstants.tamilLangkey ? AppConstants.tamilLanguageSizeMultiplier : scale );
  ...
  //     (GlobalValues.languageKey != AppConstants.englishLangkey
  //         ? AppConstants.tamilLanguageSizeMultiplier
  //         : scale);
  ...
  double setSp(num fontSize) {
    double spclscaleText = scaleText;

    //scale based on screen size and mentioned size

    final scaleSize = scale;
    double scalevalue = fontSize * spclscaleText * scaleSize;
    return scalevalue > 50 ? 50 : scalevalue;
  }
